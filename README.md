...
**TL;DR:** To test the app’s main feature, create a non-default folder, add a few entries, then manually run the timeline-generator GitHub Action and check that folder in the timeline screen.
